/*
* http://blog.hyphp.cn/t/43.html
xhr.open("post", me.editor.getOpt('imageUrl') + "&type=ajax", true);
这个原来是?type=ajax,得自己修改下,不然提交会报错
*/
...
//                }
  ...
  var Upload = {
      ...
      uploadTpl: '<div class="edui-image-upload%%">' +
          ...
          '<input id="um_up" multiple="multiple" style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="photo[]" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
          '</form>' +
      ...
      submit: function (callback) {
          ...
          var me = this,
              input = $( '<input id="um_up" multiple="multiple" style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="photo[]" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
              input = input[0];
...
//console.log( document.getElementById('um_up').files);
