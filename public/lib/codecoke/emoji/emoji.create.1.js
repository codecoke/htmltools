...
// import { firstName as f2 } from './es6.module.1.js';
// import * as t  from './es6.demo/index.js';
// import y from './es6.module.1.js';
// import z from './es6.module.1.js';
...
// console.log(z.v);
// t.default.puls();
// console.log(t.default.v);
// console.log(t.default.getScriptURL());
...
emojiTxt.replace(/(\d+.+)\n/gi,($1,index,str) => {
  // console.log('hi'+ i)
  // console.log($1.split(/\s+|;/));
  // console.log('index: '+index );
  let _v = $1.split(/\s+|;/)[0]
    ,_v_unicode = eval('(\'\\u{'+_v+'}\')')
    ,_v_16 =_v_unicode.codePointAt()
  ;
  emojiTxtObj['_'+_v]= [_v_unicode,_v_16];
  // arr.push([_v,_v_unicode,_v_16]);
  arr[i]=[_v,_v_unicode,_v_16];
  i++;
...
// console.log(earr);
// let t2 =eval('(\'\\u{'+arr[51][0]+'}\')');
// let t210 =t2.charCodeAt();
// let t3 =t2.codePointAt();
// eval("(\"\u89" + "81\")")
// document.getElementById('txt').value= JSON.stringify(emojiTxtObj).replace(/\\"/g,'\'');
// console.log(arr);
// console.log(arr[51]+' '+t2.toString(16));
// console.log('\'\\u{' + arr.join('}\',\'\\u{')+'}\'');
// console.log(y.v);
// console.log(
//   '\u2702'
//   + '\u2705'
