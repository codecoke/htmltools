...
**Note:** 這份文件本身也是用 Markdown 寫的，你也可以看看 [它的原始碼][codecokemarkdwonsrc]

  [s]: ./syntax-tw.md  "Markdown Syntax"
  [d]: http://daringfireball.net/projects/markdown/dingus  "Markdown Dingus"
  [codecokegit]: https://github.com/codecoke/htmltools/tree/master/docs
  [codecokemarkdwonsrc]: https://github.com/codecoke/htmltools/tree/master/docs/markdown/basics-tw.md
