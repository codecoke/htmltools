<%
/*
 * attr.hexcase(hex output format): 0 - lowercase; 1 - uppercase
 * attr.b64pad(base-64 pad character): "=" for strict RFC compliance
 * hex.md5(str,[Int])   Int 16 : md5 16bit ; default: 32bit;
 */
